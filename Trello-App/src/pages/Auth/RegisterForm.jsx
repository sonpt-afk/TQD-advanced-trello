          ...
          <Box sx={{ padding: '0 1em 1em 1em' }}>
            ...
            <Box sx={{ marginTop: '1em' }}>
              <TextField
                             ...
                             {...register('password', { required: FIELD_REQUIRED_MESSAGE, pattern: { value: PASSWORD_RULE, message: PASSWORD_RULE_MESSAGE } })}
                           />
            ...
            <Box sx={{ marginTop: '1em' }}>
              ...
              />
                           <FieldErrorAlert errors={errors} fieldName={'password_cf'}/>
